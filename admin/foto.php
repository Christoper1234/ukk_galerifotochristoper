  ...
  <img src="../icongeleri.jpg" style="width:50px"><a class="navbar-brand" href="index.php"><span class="fw-bolder " style="color:red; font-size:35px;">Galeri  </span> <span style="color:blue; text-shadow: 0 0 25px blue, 0 0 4px blue, 0 0 6px blue; font-size:25px;;font-size:40px;">Foto</span></a>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<div class="card mt-2">
					<div class="card-header" style="background-color:#0A2CA1; color:#F5EAED; font-weight:bold; font-size:25px "> Tambah Foto </div>
						<div class="card-body "style="background-color:#BAB197 ";>
						<form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
						<label class="form-label " style="font-size:15px ;font-weight:bold;"> Judul Foto </label>
						<input type="text" name="judulfoto" class="form-control" required>
						<label class="form-label"  style="font-size:15px ;font-weight:bold;"> Deskripsi Foto </label>
						<textarea class="form-control" name="deskripsifoto" required></textarea>
						<label class="form-label" style="font-size:15px ;font-weight:bold;"> Album </label>
						...
						<label class="form-label"  style="font-size:15px ;font-weight:bold;"> File </label>
		...
		<div class="col-md-8">
			<div class="card mt-2">
				<div class="card-header" style="background-color:#0A2CA1; color:#F5EAED; font-weight:bold; font-size:18px "> Data Galeri Foto </div>
					<div class="card-body" style="background-color:#BAB197 ">
						<table class="table">
							<thead>
								<tr>
									<th style="background-color:#525252;"> No </th>
									<th style="background-color:#525252;"> Foto </th>
									<th style="background-color:#525252;"> Judul Foto </th>
									<th style="background-color:#525252;"> Deskripsi Foto </th>
									<th style="background-color:#525252;"> Tanggal Diunggah </th>
	...
	<footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom" style="background-color:aqua;"->
