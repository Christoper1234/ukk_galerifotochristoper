...
<nav class="navbar navbar-expand-lg navbar-light py-3" style="background-color:black; box-shadow: 0 0 15px rgba(0, 0, 0, .5);">
  <div class="container">
...
<div class="container py-5" >
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card" style="box-shadow: 0 0 30px rgba(0, 0, 0, .5);">
